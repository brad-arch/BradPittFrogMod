...
public class AngryBirdDimentionModElements {
	...
	public AngryBirdDimentionModElements() {
		...
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == AngryBirdDimentionModElements.ModElement.class)
						elements.add((AngryBirdDimentionModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(AngryBirdDimentionModElements.ModElement::initElements);
	}
	...
	public <T> void addNetworkMessage(Class<T> messageType, BiConsumer<T, PacketBuffer> encoder, Function<PacketBuffer, T> decoder,
		...
		AngryBirdDimentionMod.PACKET_HANDLER.registerMessage(messageID, messageType, encoder, decoder, messageConsumer);
		messageID++;
	}
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		protected final AngryBirdDimentionModElements elements;
		protected final int sortid;
		public ModElement(AngryBirdDimentionModElements elements, int sortid) {
