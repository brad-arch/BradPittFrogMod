package net.mcreator.angrybirddimention.entity.renderer;
...
import net.mcreator.angrybirddimention.entity.FrogEntityEntity;
...
public class FrogEntityRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(FrogEntityEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelfrog_model(), 0.75f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("angry_bird_dimention:textures/frog_texture.png");
					}
				};
			});
		}
