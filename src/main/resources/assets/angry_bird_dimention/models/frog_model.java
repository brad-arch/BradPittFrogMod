...
public class frog_model extends EntityModel<Entity> {
	...
	public frog_model() {
		...
		BLLeg.setTextureOffset(22, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 4.0F, 5.0F, 0.0F, false);
		...
		BLFoot.setTextureOffset(0, 15).addBox(-1.0F, 0.0F, -7.0F, 2.0F, 1.0F, 7.0F, 0.0F, false);

		BRLeg = new ModelRenderer(this);
		BRLeg.setRotationPoint(-3.0F, 1.0F, -2.0F);
		Body.addChild(BRLeg);
		setRotationAngle(BRLeg, 0.0873F, 0.0F, 0.0F);
		BRLeg.setTextureOffset(0, 23).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 4.0F, 5.0F, 0.0F, false);
		...
		BRFoot.setTextureOffset(11, 16).addBox(-1.0F, 0.0F, -7.0F, 2.0F, 1.0F, 7.0F, 0.0F, false);
	}
